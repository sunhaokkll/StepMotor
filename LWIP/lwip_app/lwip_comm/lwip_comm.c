...
OS_STK TCPIP_THREAD_TASK_STK[TCPIP_THREAD_STACKSIZE];
...
//任务堆栈	
OS_STK  LWIP_DHCP_TASK_STK[LWIP_DHCP_STK_SIZE];	
//任务函数
...
void lwip_comm_default_ip_set(__lwip_dev *lwipx)
{
    ...
    memset(&lwipdev, 0, sizeof(lwipdev));
    //u32 sn0;
	...
	lwipx->mac[1]=0;
	lwipx->mac[2]=0;
	lwipx->mac[3]=0x0A;//低三字节用STM32的唯一ID
	lwipx->mac[4]=0x0B;;
	lwipx->mac[5]=0x0C; 
