...
#define MSD0_card_power_on()        GPIO_ResetBits(GPIOC, GPIO_Pin_8)
#define MSD0_card_power_off()       GPIO_SetBits(GPIOC, GPIO_Pin_8)
#define MSD0_card_insert()       	GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_4)
